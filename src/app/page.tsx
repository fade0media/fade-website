...
'>
        <div className='flex flex-col justify-center items-center relative z-40'>
          ...
          <h1 className="whitespace-nowrap bg-gradient-to-br from-white from-30% to-gray-400 bg-clip-text py-6 text-5xl font-bold leading-none tracking-[-0.025em] text-transparent text-balance sm:text-6xl md:text-7xl lg:text-9xl">
            Coming Soon!
