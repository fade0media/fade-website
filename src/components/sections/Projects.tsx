...
export function Projects() {
  ...
  return (
    <div  className="md:mb-72 mb-24 relative z-40 md:gap-16 flex flex-col items-center w-full px-8 md:px-24 min-h-screen overflow-y-scroll">
      <div className="flex flex-col justify-center items-center gap-4">
        <h2 className="text-3xl font-semibold md:text-4xl lg:text-5xl">Our Work</h2>
        <p className="text-xl text-gray-400">Explore some of our most creative endeavours.</p>
      </div>
