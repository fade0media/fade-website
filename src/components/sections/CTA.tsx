...
const CTA = () => {
  return (
    <div className="w-full my-8 relative flex flex-col items-start justify-center">
      ...
      <p className="text-4xl text-left sm:text-7xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-br from-sky-100 from-30% to-gray-300 via-white py-8">
