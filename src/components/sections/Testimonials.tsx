      ...
      <div className="flex flex-col justify-center items-center sm:flex-row gap-8 -my-4 mb-24">
        ...
        >
          <div className="h-full rounded-2xl">
            ...
            <p className="leading-relaxed mb-6 text-xl font-light text-gray-300">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
