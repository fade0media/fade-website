...
const Testimonials = () => {
  ...
  const text = "Our goal is to provide impactful solutions and build meaningful relationships. Don't take our word for it, heres what people who we've worked with have to say about us."
  return (
