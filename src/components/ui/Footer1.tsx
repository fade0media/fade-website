...
const Footer1 = () => {
  ...
  <div className="container flex items-start sm:flex-row flex-col mt-8">
    <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
      ...
      <span className="font-bold text-2xl">fade.</span>
    </a>
    <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 Fade Media —
      <a href="/" className="text-gray-400 ml-1" rel="noopener noreferrer" target="_blank">All Rights Reserved.</a>
    </p>
