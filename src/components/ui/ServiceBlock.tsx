...
const ServiceBlock = () => {
  return (
    <div className='flex flex-col md:flex-row justify-center items-center gap-8 w-full mt-16 h-auto'>
            ...
            <div className="md:w-1/2 w-full flex flex-col justify-center items-center gap-8 h-full">
                <Link
                 ...
                 className='flex-1 border border-gray-400 border-opacity-30 group bg-[url(/cover.png)] bg-cover w-full h-1/2 pt-28 text-black rounded-2xl'>
                    <div className=' w-full flex justify-start bg-left items-center gap-4 bg-opacity-5 rounded-tr-2xl rounded-bl-2xl px-3 whitespace-nowrap md:px-8 py-3'>
                        <p className='text-white text-xl md:text-2xl rounded-bl-2xl back'>Project Name</p>
                ...
                <Link
                 href="#"
                 className='flex-1 border border-gray-400 border-opacity-30 group bg-[url(/cover.png)] bg-cover w-full h-1/2 pt-28 text-black rounded-2xl'>
                    <div className=' w-1/2 flex justify-start  items-center gap-4 bg-opacity-5 rounded-tr-2xl rounded-bl-2xl px-3 md:px-8 py-3 whitespace-nowrap '>
