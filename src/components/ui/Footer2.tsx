...
const Footer2 = () => {
  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <span className="inline-flex sm:ml-auto mt-4 justify-center sm:justify-start">
      ...
      <a className="ml-3 text-white" href="https://www.linkedin.com/company/fadegroup/posts/?feedView=all" target='_blank'>
  ...
  <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-gray-600 border-opacity-40 lg:flex-row">
    ...
    <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
      ...
      <li>
        <a href="/privacy-policy" className="text-md text-gray-500 font-bold transition-colors duration-300 hover:text-deep-purple-accent-400">Privacy Policy</a>
      </li>
      <li>
        <a href="/terms-and-conditions" className="text-md text-gray-500 font-bold transition-colors duration-300 hover:text-deep-purple-accent-400">Terms &amp; Conditions</a>
      </li>
    </ul>
  </div>
</div>
